...
export const t: Record<'fr' | 'ar', Translation> = {
  ...
  ar: {
    ...
    subtitle: "الشركة المعدنية لإيميدر (SMI) — الإجراءات التشغيلية للحفر والتفجير عالي الأداء",
    ...
    step9Title: "عملية الإشعال والتفجير (Tir) هي ثمرة كل هذا العمل الشاق. الخمس عشرة دقيقة السابقة للتفجير هي الأكثر خطورة وحرجاً — أي خطأ في قائمة الفحص (Check-list) هنا قد يضيع مجهود اليوم كاملاً.",

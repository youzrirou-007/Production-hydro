...
export const t: Record<'fr' | 'ar', Translation> = {
  ...
  ar: {
    ...
    stepHeaders: [
      ...
      { num: 4, icon: '⛏️', title: 'تطهير السقف والجوانب (Purge)', cat: 'SÉCURITÉ' },
      ...
      { num: 10, icon: '📝', title: 'تسجيل البيانات في السجل اليومي (Rapport journalier)', cat: 'TECHNIQUE' }
    ],
    ...
    step1Alert: "الثقب المتخلف (Trou raté) غير المبلغ عنه من الوردية السابقة يمثل خطراً قاتلاً. يجب المطالبة بتأكيد صريح لحالة الثقوب قبل دخول النفق.",
    ...
    step4Title: "تتمثل عملية التطهير (Purge) في إسقاط جميع الكتل الصخرية غير المستقرة من السقف (Voûte) والجوانب (Parements) على مسافة لا تقل عن 15 متراً من جبهة الحفر (Front de taille). وتتم هذه العملية بعد رش الماء (Arrosage)، بعد أن كشفت الصخور عن شقوقها.",
    ...
    step5Title: "قبل تشغيل آلة الحفر (Perforatrice)، يتم فحص كل جزء بدقة. إن انفجار خرطوم (Flexible) تحت ضغط 10 بار (Bar) يتحول إلى سوطٍ قاتلٍ داخل النفق.",

...
export const t: Record<'fr' | 'ar', Translation> = {
  fr: {
    ...
    earSpecsDesc: "Casque anti-bruit obligatoire avant démarrage du perforateur. Niveau sonore forage : 100-110 dB. Exposition non protégée = perte auditive irréversible.",
    ...
    purgeEquipTitle: "Pince à Purger & Bec de Purge Type 2",
    purgeEquipDesc1: "La pince à purger est une barre robuste en acier spécial ou alliage léger d'aluminium haute résistance, conçue spécifiquement pour la purge minière manuelle.",
    ...
    colonneConfig18: "Barre 1.8m (forage 1.7m = 170cm) : bourrage 76cm → colonne ANFO 94cm",
    colonneConfig24: "Barre 2.4m (forage 2.3m = 230cm) : bourrage 76cm → colonne ANFO 154cm",
    ...
    step10Grid3Title: "📏 Barre utilisée",
    step10Grid3Desc: "Barre 1.8m (forage 1.7m) ou Barre 2.4m (forage 2.3m)",
    ...
    step10Grid5Desc: "= Longueur barre × 1 (par trou) — hors trous vides",
    ...
    lightboxPurgeTitle: "🔍 Illustration : Pince à purger & Bec Type 2 (Agrandie)",
    lightboxForageTitle: "🔍 Illustration : Perforateur Montabert T23 & Poussoir (Agrandie)",
    lightboxSoufflageTitle: "🔍 Illustration : Nettoyage & Soufflage du Trou (Agrandie)",
    lightboxPurgeDesc: "Détail haute définition de la pince à purger et du bec de Type 2 SMI avec biseau double trempé de 35° engagé dans la fissure.",
    ...
    step9Checklist: [
      ...
      "Pince à purger replacée — hors zone tir",
  ...
  ar: {
    ...
    subtitle: "شركة معادن إيميدر (SMI) — الإجراءات التشغيلية للحفر والتفجير عالي الأداء",
    ...
    earSpecsDesc: "واقيات الأذن أو السماعات المضادة للضوضاء (Casque antibruit) إلزامية قبل بدء تشغيل آلة الحفر (Perforatrice). مستوى ضجيج الحفر: 100-110 ديسيبل (dB). التعرض بدون حماية يؤدي إلى فقدان السمع بشكل دائم وغير قابل للاسترداد.",
    ...
    gabarit12m2Label: "معيار (Gabarit) SMI 12م²: 38 ثقباً | القطع (Bouchon): 3 فارغة (Trous vides) + 6 معبأة بالتوفيكس (Tovex) | 6 مجموعات (Groupes) | D0 ← D5",
    gabaritIntlLabel: "المعيار الدولي (Gabarit International) 12م²: 38 ثقباً | القطع (Bouchon): 6 فارغة (Trous vides) + 3 معبأة بالتوفيكس (Tovex) | 6 مجموعات (Groupes) | D0 ← D5",
    gabarit9m2Label: "مقطع (Gabarit) 9م²: 28 ثقباً | القطع (Bouchon): 1 فارغة (Trou vide) + 4 معبأة بالتوفيكس (Tovex) | 5 مجموعات (Groupes) | D0 ← D4",
    ...
    parallelismeDesc: "يجب أن تكون جميع الثقوب متوازية تماماً (Parallèles) مع بعضها البعض وعمودية على جبهة الحفر (Front de taille). أي ثقب منحرف (Trou dévié) يخلف قعراً متبقياً (Culot) يتراكم من تفجير لآخر معيقاً تقدم العمل.",
    ...
    purgeEquipTitle: "عمود التقشير (Canne de purge) ورأس التقشير من النوع 2 (Tête de purge Type 2)",
    purgeEquipDesc1: "عمود التقشير (Canne de purge) هو قضيب متين مصنع من الصلب الخاص أو سبائك الألومنيوم الخفيفة وعالية المقاومة، مصمم خصيصاً لعمليات تقشير الصخور اليدوية في المناجم.",
    purgeEquipDesc2: "يتميز رأس التقشير من النوع 2 (Tête de purge Type 2) (المعتمد لدى منجم إيميدر SMI) بزاوية رافعة مثالية وحافة صلبة مزدوجة الشطب. يتيح ذلك إدخاله بدقة في شقوق الانفصال لإزالة القشور الصخرية غير المستقرة ميكانيكياً من مسافة آمنة.",
    ...
    bourrageProc5: "التأكد من خروج سلك المفجر (Fil de détonateur) بشكل سليم ودون أي التواء أو انحشار",
    step10Desc: "تقييد البيانات في السجل اليومي (Rapport journalier) هو آخر خطوة فنية يقوم بها عامل المنجم. تغذي هذه البيانات منصة هيدرومينز للإنتاج (HydroMines Production) مباشرة، لذا يجب أن تكون دقيقة وكاملة.",
    ...
    step10Grid2Title: "🔩 توزيع شحنة القطع (Charge du bouchon)",
    ...
    step10Alert: "أي خطأ في السجل اليومي (Rapport journalier) يؤثر سلباً في تتبع حركة المتفجرات ويهدد سلامة الوردية القادمة (Poste suivant). دقة السجل تعكس مدى انضباط واحترافية عامل المنجم.",
    lightboxPurgeTitle: "توضيح: عمود التقشير (Canne de purge) ورأس التقشير من النوع 2 (Tête de purge Type 2) (صورة مكبرة)",
    ...
    lightboxPurgeDesc: "تفاصيل عالية الدقة لعمود التقشير (Canne de purge) ورأس التقشير المعتمد من SMI مع شطب مزدوج مقسى بزاوية 35 درجة موضوع في الشق الصخري.",
    ...
    stepHeaders: [
      { num: 1, icon: '📋', title: 'استلام الوردية والتوجيهات الفنية (Consignes de poste)', cat: 'TECHNIQUE' },
      { num: 2, icon: '🌬', title: 'التحقق من التهوية (Vérification de l\'aérage)', cat: 'TECHNIQUE' },
      { num: 3, icon: '💧', title: 'رش ورشة العمل بالماء (Arrosage du chantier)', cat: 'TECHNIQUE' },
      { num: 4, icon: '⛏️', title: 'تقشير السقف والجوانب (Purge)', cat: 'SÉCURITÉ' },
      { num: 5, icon: '🔧', title: 'فحص معدات الحفر (Contrôle de la perforatrice)', cat: 'TECHNIQUE' },
      { num: 6, icon: '🔩', title: 'الحفر (Forage) — تحقيق 100% من العمق', cat: 'FORAGE' },
      { num: 7, icon: '🔍', title: 'فحص وتنظيف الثقوب (Soufflage et contrôle)', cat: 'TECHNIQUE' },
      { num: 8, icon: '💥', title: 'تعبئة وشحن المتفجرات (Chargement des explosifs)', cat: 'EXPLOSIFS' },
      { num: 9, icon: '🔌', title: 'التحضير للتفجير والإشعال (Raccordement et tir)', cat: 'TECHNIQUE' },
      { num: 10, icon: '📝', title: 'تقييد البيانات في السجل اليومي (Rapport journalier)', cat: 'TECHNIQUE' }
    ],
    step1Title: "إن ما تتلقاه من الوردية السابقة (Poste précédent) يحدد مدى كفاءتك وسلامتك طوال اليوم.",
    step1Grid: [
      ...
      { title: "⚠️ العيوب والمشاكل المبلغ عنها (Anomalies signalées)", text: "المناطق غير المستقرة (Zones instables)، تسرب المياه (Venues d'eau)، حوادث الوردية السابقة." }
    ],
    step1Alert: "الثقب الفاشل (Trou raté) غير المبلغ عنه من الوردية السابقة يمثل خطراً قاتلاً. يجب المطالبة بتأكيد صريح لحالة الثقوب قبل دخول النفق.",
    step2Title: "التهوية (Aérage) هي أول فحص فني قبل أي دخول إلى النفق. النفق الذي يفتقر للتهوية الجيدة يحتوي على أحادي أكسيد الكربون (CO) وغازات النيتروجين السامة (Gaz nitreux) غير المرئية والمميتة بعد التفجير.",
    ...
    step2Proc: [
      ...
      "في حالة وجود كاشف الغاز (Détecteur de gaz): يجب أن تكون القراءة أقل من 25 جزء في المليون (ppm) قبل الدخول",
      "الحد الأدنى للانتظار بعد التفجير: 30 دقيقة من التهوية المستمرة (Aérage continu) قبل أي دخول للورشة (Chantier)",
      "التأكد من وصول الهواء إلى جبهة الحفر (Front de taille) — وليس فقط عند مدخل النفق"
    ],
    step2Alert: "التهوية (Aérage) ليست اختيارية. إذا كانت التهوية غير كافية — قف (STOP) — يمنع العمل تماماً حتى تتم استعادة التدفق المطابق للمواصفات.",
    step3Title: "رش الماء (Arrosage) يسبق دائماً عملية تقشير السقف والجوانب (Purge). فالماء يرطب الصخور ويكشف عن الشقوق (Fissures)، ومناطق الانفصال (Plans de rupture)، والكتل غير المستقرة التي لا يمكن رؤيتها بالعين المجردة عندما تكون جافة. الورشة غير المرشوشة تخفي مخاطرها.",
    step3Alert: "يكشف الماء ما لا تراه العين على الصخور الجافة. الرش بالماء (Arrosage) = التحضير لتقشير (Purge) فعال وآمن.",
    step3ProcTitle: "خطوات الرش بالماء (Procédure d'arrosage):",
    step3Proc: [
      "توصيل خرطوم المياه (Tuyau d'eau) بأنبوب الورشة الرئيسي",
      "رش جبهة الحفر (Front de taille) أولاً: المناطق المتشققة، ومستويات الطبقات، والعيوب الظاهرة",
    ...
    step4Title: "تتمثل عملية التقشير (Purge) في إسقاط جميع الكتل الصخرية غير المستقرة من السقف (Voûte) والجوانب (Parements) على مسافة لا تقل عن 15 متراً من جبهة الحفر (Front de taille). وتتم هذه العملية بعد رش الماء (Arrosage)، بعد أن كشفت الصخور عن شقوقها.",
    step4RuleTitle: "قواعد صارمة لا غنى عنها (Règles de purge):",
    step4Rules: [
      "يجب إيقاف جميع الآلات تماماً أثناء التقشير (Purge) — الاستماع لصوت الاهتزازات والتصدعات (Bruits de la roche) أمر بالغ الأهمية لسلامتك",
      "قف دائماً خارج منطقة السقوط المحتملة (Zone d'éboulement) — لا تقف أبداً تحت كتلة صخرية تقوم بتقشيرها",
      "اطرق السقف (Voûte) والجوانب (Parements) بشكل منهجي — الصوت الأجوف (Son sourd) = كتلة غير مستقرة يجب إسقاطها فوراً | الصوت الممتلئ أو المعدني (Son clair) = صخرة مستقرة، واصل العمل",
      "ينتهي التقشير (Purge) عندما تعطي جميع المناطق المختبرة بنسبة 100% صوتاً ممتلئاً — وليس 99%",
      "مسافة العمل الآمنة: 15 متراً كحد أدنى من الجبهة (Front)"
    ],
    step4AlertSafety: "الكتلة الصخرية التي لم تتم إزالتها قد تسقط أثناء الحفر (Forage) أو التعبئة (Chargement). كتلة واحدة تكفي لإحداث كارثة. لا تستهن أبداً بعملية التقشير (Purge) ولا تختصرها.",
    step5Title: "قبل تشغيل آلة الحفر (Perforatrice)، يتم فحص كل جزء بدقة. إن انفجار خرطوم (Flexible) تحت ضغط 10 بار (Bar) يشبه إطلاق قذيفة داخل النفق.",
    ...
    step5Checklist: [
      ...
      "وصلة مياه الحفر (Infection d'eau): التوصيل محكم ولا يوجد تسريب",
    ...
    step5SafetyAlert: "إن خرطوم الهواء (Flexible d'air) الخاضع لضغط 10 بار (Bar) إذا انفصل أو انفجر يتحول إلى سوط عنيف ومميت. يجب تأمين كل وصلة تماماً قبل تشغيل الضغط.",
    step5NoiseTitle: "🎧 معدات حماية السمع (Protection auditive)",
    step5NoiseDesc: "واقي الأذن أو خوذة الحماية من الضوضاء (Casque antibruit) إلزامي قبل بدء تشغيل آلة الحفر (Perforatrice). مستوى ضجيج الحفر: 100-110 ديسيبل (dB). التعرض بدون حماية يؤدي إلى فقدان السمع بشكل دائم.",
    step7Title: "قبل تعبئة المتفجرات (Explosifs)، يتم تنظيف كل ثقب بالنفخ (Soufflage) وفحصه بدقة. أي ثقب مسدود أو غير عميق بما يكفي = انحشار خرطوشة التوفيكس (TOVEX) = فشل التفجير (Raté de tir).",
    ...
    step7Advice: "💡 نصيحة: عملية النفخ (Soufflage) القوية تحرر غبار السيليكا (Silice) المتبقي. ارتدِ قناع التنفس المزود بمرشح (Masque antipoussière) إلزامياً أثناء هذه العملية!",
    step7VisualTitle: "ثقب منسق ومنظف بالكامل (Trou soufflé et propre)",
    step7Alert: "تعبئة ثقب مبلل بخليط الأنفور (ANFO) = فشل تفجير حتمي (Raté de tir). يتميز التوفيكس (TOVEX) بمقاومته الفائقة للمياه ويضمن الانفجار حتى في الثقوب المغمورة. يجب تكييف نوع المتفجر حسب حالة كل ثقب.",
    step8Title: "تتمة عملية الشحن والتعبئة (Chargement des explosifs) قبل 30 إلى 60 دقيقة من موعد التفجير. الترتيب إلزامي وصارم: التوفيكس (TOVEX) أولاً، ثم الأنفور (ANFO)، يليهما الحشو (Bourrage) في النهاية.",
    ...
    step9Title: "عملية الإشعال والتفجير (Tir) هي ثمرة كل هذا العمل الشاق. الدقائق الخمس عشرة دقيقة السابقة للتفجير هي الأكثر خطورة وحرجاً — أي خطأ في قائمة الفحص (Check-list) هنا قد يضيع مجهود اليوم كاملاً.",
    ...
    step9Checklist: [
      ...
      "إعادة عمود التقشير (Canne de purge) إلى مكانه الآمن خارج منطقة التفجير",
      ...
      "جهاز القياس أو الجلفانومتر (Ohmmètre / Galvanomètre): تأكيد سلامة وتوصيل الدائرة كاملة",

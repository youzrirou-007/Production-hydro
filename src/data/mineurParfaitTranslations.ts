...
export const t: Record<'fr' | 'ar', Translation> = {
  ...
  ar: {
    ...
    lightboxPurgeDesc: "رسم تفصيلي لعمود التقشير ورأس التقشير المعتمد لدى منجم EXCELLENCE مع زاوية ميلان 35 درجة داخل الفالق الصخري.",
    ...
    step9Proc: [
      ...
      "توصيل سلك التفجير الرئيسي بجهاز الإشعال (Exploseur) المعتمد من EXCELLENCE",

...
export const t: Record<'fr' | 'ar', Translation> = {
  fr: {
    ...
    subtitle: "CHANTIER MINIER (X) — PROCÉDURES OPÉRATIONNELLES DE FORAGE & TIR DE PERFORMANCE",
    ...
    gabarit12m2Label: "12m² EXCELLENCE : 38 trous | Bouchon : 3V + 6C | 6 groupes | D0 → D5",
    ...
    arrache: "Arraché",
    rendement: "Rendement",
    purgeEquip: "Équipement Certifié EXCELLENCE",
    ...
    purgeEquipDesc2: "Le bec de purge de Type 2 (Spécification CHANTIER MINIER (X)) possède un angle de levier optimisé et un tranchant trempé à double biseau. Il permet de s'insérer précisément dans les fractures de décollement pour déloger mécaniquement les dalles instables à distance de sécurité.",
    ...
    step10Desc: "La déclaration dans le registre journalier est l'acte technique final du mineur. Elle alimente directement la plateforme Excellence Production — les données doivent être exactes et complètes.",
    ...
    step10Grid2Desc12m2: "3 vides + 6 chargés (ANFO + 2 TOVEX 200g)",
    step10Grid2DescIntl: "6 vides + 3 chargés (ANFO + 2 TOVEX 200g)",
    step10Grid2Desc9m2: "1 vide + 4 chargés (ANFO + 2 TOVEX 200g)",
    ...
    step10Grid4Desc: "ANFO : dans tous les trous chargés | TOVEX : 2 cartouches/bouchon + 1/autres | Amorces = 1 par trou chargé",
    ...
    lightboxPurgeDesc: "Détail haute définition de la canne de purge et du bec de Type 2 EXCELLENCE avec double biseau trempé de 35° engagé dans la fissure.",
    ...
    step9Proc: [
      ...
      "Raccorder le fil de tir à l'appareil de tir homologué EXCELLENCE",
  ...
  ar: {
    title: "دليل عامل المنجم Parfait (Le Mineur Parfait)",
    subtitle: "EXCELLENCE — دليل إجراءات الحفر والتفجير عالي الأداء",
    ...
    smiGabarit: "🔷 نموذج 12م² — EXCELLENCE",
    ...
    gabarit12m2Label: "نموذج 12م² لـ EXCELLENCE: 38 ثقباً | ثقوب القطع (البوشون): 3 فارغة + 6 معبأة بالتوفيكس | 6 مجموعات | من D0 إلى D5",
    ...
    ordreForageTitle: "بروتوكول وقواعد عملية الحفر (Forage):",
    ...
    rendement: "المردودية",
    purgeEquip: "معدات معتمدة من شركة EXCELLENCE",
    ...
    purgeEquipDesc2: "يتميز رأس التقشير من الصنف 2 (المعتمد في منجم EXCELLENCE) بزاوية رافعة محسنة وشفرة حادة صلبة ذات شطب مزدوج. يسمح هذا التصميم بإدخاله بدقة في شقوق الانفصال لإسقاط الألواح الصخرية غير المستقرة ميكانيكياً مع الحفاظ على مسافة أمان كافية.",
    ...
    colonneConfig18: "الفلوريه (Fleuret) 1.8م (عمق الحفر 1.7م = 170سم): الحشو 76سم ← عمود الأنفو (ANFO) 94سم",
    colonneConfig24: "الفلوريه (Fleuret) 2.4م (عمق الحفر 2.3م = 230سم): الحشو 76سم ← عمود الأنفو (ANFO) 154سم",
    quantitiesTitle: "الكميات التقريبية المطلوبة لهذا المقاس",
    qAnfoTotal: "إجمالي الأنفو (ANFO)",
    qTovex100g: "توفيكس (وحدات / 100غ)",
    qAmorces: "الصواعق",
    ...
    step10Desc: "إن تسجيل البيانات في السجل اليومي هو الخطوة التقنية الختامية لعامل المنجم. ترسل هذه البيانات مباشرة إلى منصة Excellence Production، لذا يجب أن تكون دقيقة وشاملة بالكامل.",
    ...
    step10Grid2Desc12m2: "3 ثقوب فارغة + 6 معبأة (أنفو + خرطوشتي توفيكس 200غ)",
    step10Grid2DescIntl: "6 ثقوب فارغة + 3 معبأة (أنفو + خرطوشتي توفيكس 200غ)",
    step10Grid2Desc9m2: "1 ثقب فارغ + 4 معبأة (أنفو + خرطوشتي توفيكس 200غ)",
    step10Grid3Title: "📏 نوع الفلوريه (Fleuret) المستخدم",
    step10Grid3Desc: "الفلوريه (Fleuret) 1.8م (عمق 1.7م) أو الفلوريه 2.4م (عمق 2.3م)",
    step10Grid4Title: "💥 المتفجرات المستهلكة",
    step10Grid4Desc: "أنفو (ANFO): في كل الثقوب المحملة | توفيكس (TOVEX): خرطوشتان للبوشون وواحدة للباقي | صواعق = صاعق لكل ثقب محمل",
    step10Grid5Title: "📐 مجموع أمتار الحفر المصرح بها",
    step10Grid5Desc: "= طول الفلوريه (Fleuret) × عدد الثقوب (باستثناء الثقوب الفارغة)",
    ...
    lightboxPurgeTitle: "رسم توضيحي: قضيب التقشير ورأس التقشير من الصنف 2 (مكبّر)",
    ...
    lightboxPurgeDesc: "رسم تفصيلي لقضيب التقشير ورأس التقشير المعتمد لدى منجم EXCELLENCE مع زاوية ميلان 35 درجة داخل الفالق الصخري.",
    ...
    stepHeaders: [
      { num: 1, icon: '📋', title: '1. الإحاطة وتبادل المعلومات (Relève de poste)', cat: 'فني' },
      { num: 2, icon: '🌬', title: 'التحقق من تهوية الرواق', cat: 'فني' },
      { num: 3, icon: '💧', title: '3. رش المياه وغسل الجبهة (Lavage de la frontière)', cat: 'فني' },
      { num: 4, icon: '⛏️', title: 'تقشير السقف والجوانب (Purge)', cat: 'سلامة' },
      { num: 5, icon: '🔧', title: 'فحص وتدقيق معدات الحفر', cat: 'فني' },
      { num: 6, icon: '🔩', title: '6. عملية الحفر (Forage)', cat: 'حفر' },
      { num: 7, icon: '🔍', title: '7. تنظيف ونفخ الثقوب (Soufflage des trous)', cat: 'فني' },
      { num: 8, icon: '💥', title: 'شحن وتعبئة المواد المتفجرة', cat: 'متفجرات' },
      { num: 9, icon: '🔌', title: 'التحضير للنسف وإطلاق الشرارة', cat: 'فني' },
      { num: 10, icon: '📝', title: '10. سجل العمليات وتوثيق الورديات (Rapport de tir)', cat: 'فني' }
    ],
    step1Title: "1. الإحاطة وتبادل المعلومات (Relève de poste) — الاستلام والتسليم بين الورديات",
    step1Grid: [
      ...
      { title: "📦 مخزون المتفجرات", text: "هل الأنفو (ANFO)، والتوفيكس (TOVEX)، والصواعق متوفرة بكميات كافية؟" },
    ...
    step2Title: "التهوية هي أول فحص تقني قبل أي دخول إلى الرواق. الرواق الذي يفتقر للتهوية الجيدة يحتوي على غاز أحادي أكسيد الكربون (CO) وأكاسيد النيتروجين السامة (Gaz nitreux) الناتجة عن التفجير، وهي غازات غير مرئية وقاتلة.",
    step2ProcTitle: "بروتوكول التحقق:",
    step2Proc: [
      "التحقق من تدفق الهواء عند مدخل الرواق — يجب الشعور بتيار الهواء على بشرة الوجه",
      "فحص حالة المروحة وأنبيب التهوية المرن (الكم / Gaine): خلوها من الالتواءات والتمزقات والتأكد من إحكام التوصيلات",
    ...
    step3Title: "3. رش المياه وغسل الجبهة (Lavage de la frontière) — ترطيب الجبهة والتهدئة من الغبار",
    ...
    step4Rules: [
      ...
      "طرق السقف والجوانب بشكل منهجي بمقبض قضيب التقشير — الصوت الأجوف = كتلة غير مستقرة تجب إزالتها فوراً | الصوت المعدني الرنان = صخرة مستقرة، واصل العمل",
    ...
    step5Flex: [
      ...
      "وصلة الهواء المضغوط محمية بواسطة: \n← مرابط أمان أو كابلات السلامة ضد الارتداد والضربات المفاجئة (Câbles anti-fouet)",
    ...
    step7Title: "7. تنظيف ونفخ الثقوب (Soufflage des trous) والتحقق من العمق",
    ...
    step7Checklist: [
      ...
      "الفحص الدقيق لرطوبة الثقب ووجود المياه: \n← ثقب جاف: يمكن شحنه بخليط الأنفو (ANFO) عالي الأداء \n← ثقب رطب أو مغمور بالماء: يُشحن بالتوفيكس (TOVEX) فقط (لأن الأنفو يذوب بالماء ويفقد مفعوله)",
    ...
    step7Alert: "تعبئة ثقب مبلل بخليط الأنفو (ANFO) يعني فشل التفجير حتماً في هذا الثقب. يتميز التوفيكس (TOVEX) بمقاومته الفائقة للمياه وضمان الإشعال حتى في الثقوب المغمورة. يجب تكييف نوع المتفجر حسب حالة كل ثقب.",
    step8Title: "تتم عملية شحن وتعبئة المواد المتفجرة قبل 30 إلى 60 دقيقة من موعد التفجير. ترتيب الشحن إلزامي وصارم: التوفيكس (TOVEX) أولاً في قاع الثقب، ثم الأنفو (ANFO)، يليهما الحشو (Bourrage) في النهاية.",
    step8TovexTitle: "1. التوفيكس (TOVEX) مع الصاعق (Amorce) — خرطوشة التنشيط (Cartouche amorcée)",
    step8TovexProc: [
      "أخذ خرطوشة التوفيكس (100 غرام)",
      "إدخال كبسولة الصاعق الكهربائي بعناية داخل خرطوشة التوفيكس",
      "قاعدة صارمة ومقدسة — قصر الدائرة وربط أسلاك الصاعق (Shuntage):",
      "يجب أن تظل أسلاك الصاعق ملفوفة ومربوطة معاً (مقصورة الدائرة) بشكل مستمر حتى لحظة التوصيل النهائي بسلك التفجير الرئيسي. لا تترك أي سلك حراً أبداً. السلك الحر يمكن أن يلتقط الشحنات الكهربائية الساكنة أو التيارات الشاردة مما يتسبب في تفجير مفاجئ ومميت.",
      "إدخال خرطوشة التوفيكس المجهزة بالصاعق برفق إلى قاع الثقب تماماً",
      "لا تضغط بقوة مفرطة ولا تستخدم الفلوريه (Fleuret) أو أي معدن لدفع الخرطوشة تفادياً لخطر الاحتكاك أو الصدم",
      "يجب أن يخرج سلك الصاعق من فوهة الثقب ويظل موصول الطرفين ومقصور الدائرة (Shunté)"
    ],
    step8PortanoleTitle: "2. جهاز الشحن الهوائي (Portanole) — تعبئة الأنفو (ANFO)",
    step8PortanoleProc: [
      "التأكد من توصيل الخرطوم المانع للشحنات الساكنة (Tuyau antistatique) بجهاز الشحن الهوائي (البورتانول)",
      "التحقق من سلامة الخرطوم وموصلية الأرضي — لا توجد قطوع أو اهتراء",
      "إدخال نهاية الخرطوم إلى قاع الثقب المُراد شحنه",
      "تعبئة خليط الأنفو (ANFO) في خزان جهاز الشحن",
    ...
    step9Proc: [
      ...
      "توصيل سلك التفجير الرئيسي بجهاز التفجير الكهربائي (Exploseur / الإكسبلوزور) المعتمد من EXCELLENCE",
    ...
    activeGroupLabels: {
      ...
      25: "D1 — 25 مللي ثانية — المجموعة 1 بالأنفو (ANFO)",
      50: "D2 — 50 مللي ثانية — المجموعة 2 بالأنفو (ANFO)",
      75: "D3 — 75 مللي ثانية — المجموعة 3 بالأنفو (ANFO)",
      100: "D4 — 100 مللي ثانية — المجموعة 4 بالأنفو (ANFO)",
      contour: "D5 — 125 مللي ثانية — ثقوب المحيط (الأرضية / الجوانب / السقف) بالأنفو (ANFO)"
    }
  }
};

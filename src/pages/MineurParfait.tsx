...
const HOLES_12M2_SMI: Hole[] = [
  ...
  { id: 'g1_1', x: 430, y: 470, type: 'g1', delay: 25, label: '1' },
  { id: 'g1_2', x: 570, y: 470, type: 'g1', delay: 25, label: '1' },
              ...
              {expandedStep === 4 && (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                    <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/60">
                      <div className="font-black text-slate-800 text-[10px] tracking-wider uppercase mb-1">🛠️ Matériel Recommandé</div>
                      <p className="font-semibold text-[#b8860b]">Pince à purger — adaptée à la hauteur de la galerie</p>
                    </div>
                    <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/60">
                      <div className="font-black text-slate-800 text-[10px] tracking-wider uppercase mb-1">🏷️ Spécification SMI</div>
                      <p className="font-semibold text-slate-700">Bec de purge TYPE 2 — SMI Imiter</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-slate-50 p-5 rounded-xl border border-slate-200/60">
                      ...
                      <ul className="space-y-2 text-slate-700 font-medium">
                        ...
                        <li>☐ Raccord d'air comprimé protégé par :<br/><span className="text-slate-500 pl-4">→ Colliers métalliques de sécurité</span><br/><span className="text-slate-500 pl-4">→ Ou câbles anti-fouet homologués</span></li>
                        <li>☐ Attaches et colliers serrés des deux côtés</li>
                        <li>☐ Flexible d'eau de forage : état vérifié</li>
                      </ul>
                    </div>
                  </div>
          ...
          <div className={`bg-white rounded-2xl border transition-all duration-300 overflow-hidden ${expandedStep === 7 ? 'border-[#b8860b]/60 shadow-[0_4px_20px_rgba(184,134,11,0.08)]' : 'border-slate-100 hover:border-[#b8860b]/20 shadow-xs'}`}>
            ...
            <AnimatePresence initial={false}>
              {expandedStep === 7 && (
                ...
                >
                  <p className="font-bold text-slate-800 text-sm mb-4">
                    Avant le chargement explosifs, chaque trou est soufflé et contrôlé. Un trou bouché ou insuffisamment profond = cartouche TOVEX coincée = raté de tir.
                  </p>
                  <div className="bg-slate-50 p-5 rounded-xl border border-slate-200/60 space-y-3.5">
                    <h4 className="font-black uppercase text-[10px] tracking-widest text-slate-500">Checklist technique :</h4>
                    <ul className="space-y-3 text-slate-700 font-medium">
                      ...
                      <li className="flex items-start gap-2.5">
                        <span className="text-[#b8860b] font-bold">☐</span>
                        <span>Vérification profondeur : tige de mesure dans chaque trou <br/>
                          <span className="text-slate-500 pl-4">→ Trou trop court : noter la référence, ne pas charger</span><br/>
                          <span className="text-slate-500 pl-4">→ Profondeur conforme : marquer le trou (craie ou repère)</span>
                        </span>
                      </li>
                      <li className="flex items-start gap-2.5">
                        <span className="text-[#b8860b] font-bold">☐</span>
                        <span>Vérification absence d'eau dans les trous<br/>
                          <span className="text-slate-500 pl-4">→ Trou sec : chargeable ANFO</span><br/>
                          <span className="text-slate-500 pl-4">→ Trou mouillé : TOVEX uniquement (ANFO se dissout dans l'eau)</span>
                        </span>
                      </li>
                      <li className="flex items-start gap-2.5">
                        <span className="text-[#b8860b] font-bold">☐</span>
                        <span>Contrôle visuel des trous de bouchon :<br/>
                          <span className="text-slate-500 pl-4">→ Alignement correct des vides et des chargés</span><br/>
                          <span className="text-slate-500 pl-4">→ Distance entre vides et chargés conforme au plan</span>
                        </span>
                      </li>
                      <li className="flex items-start gap-2.5">
                        <span className="text-[#b8860b] font-bold">☐</span>
                        <span>Déblayage de la zone de travail (déblais, outils)</span>
                      </li>
                    </ul>
                  </div>
